...
- [`dotnet package list --include-transitive`](https://learn.microsoft.com/en-us/dotnet/core/tools/dotnet-package-list) and [`dotnet nuget why`](https://learn.microsoft.com/en-us/dotnet/core/tools/dotnet-nuget-why) for being crappy too-little-too-late first-party attempts that don't solve this problem (no transitive dependency graph with all edges, and not full project, respectively)
